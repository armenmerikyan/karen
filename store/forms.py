...
class WebsiteProfileForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'bird_eye_api_key', 'deepseek_api_key', 'chatgpt_api_key', 'chatgpt_model_id', 'chatgpt_model_id_current'
        ]
...
class LandingPageForm(forms.ModelForm):
    class Meta:
        model = LandingPage
        fields = ['name', 'description', 'goal', 'domain_name', 'is_activated', 'is_docker', 'docker_name', 'content', 'docker_id', 'port']