...
class WebsiteProfileForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['name', 'about_us', 'wallet', 'x_handle', 'tax_rate', 'terms_of_service', 'privacy_policy', 'stripe_publishable_key', 'stripe_secret_key', 'bird_eye_api_key', 'deepseek_api_key', 'chatgpt_api_key']
